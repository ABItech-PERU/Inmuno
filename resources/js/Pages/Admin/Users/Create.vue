...
const submit = () => {
    form.post('/admin/users', {
        ...
        onError: (errors) => {
            toastRef.value?.show('Error al crear el usuario', 'error');
        },
    });
};
</script>
    ...
    <AppLayout title="Crear Usuario">
        ...
        <div class="min-h-screen bg-gray-50">
            ...
            <div class="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6">
                <form @submit.prevent="submit" class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
                    ...
                    <!-- Roles y Estado -->
                    <div class="mb-8">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Roles y Estado</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    Estado *
