...
const submit = () => {
    form.post('/admin/vacunas', {
        onSuccess: () => {
            // La redirección se maneja en el controlador, pero podemos mostrar mensaje antes
            showNotification('success', 'Vacuna creada', 'La vacuna ha sido registrada exitosamente.');
        },
        onError: (errors) => {
            const errorMessage = errors.message || 'Ocurrió un error al crear la vacuna.';
...
<template>
    <AppLayout title="Nueva Vacuna">
        <Head title="Nueva Vacuna" />
            ...
            <div class="bg-white shadow-sm border-b border-gray-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div class="flex items-center space-x-3 mt-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Nueva Vacuna</h1>
                            <p class="text-sm text-gray-600">Agrega una nueva vacuna al catálogo del sistema</p>
                        </div>
                    </div>
                </div>
            </div>
