<template>
    <AppLayout title="Editar Dependiente">
        <Head title="Editar Dependiente" />
            ...
            <div class="bg-white shadow-sm border-b border-gray-200">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div class="flex items-center space-x-3 mt-4">
                        ...
                        <div class="flex-1">
                            <h1 class="text-2xl font-bold text-gray-900">Editar dependiente</h1>
                            <p class="text-sm text-gray-600">Modifica la información de {{ dependiente.nombres }} {{ dependiente.apellidos }}</p>
                        </div>
                        ...
                        <div class="hidden md:flex items-center space-x-6 text-sm text-gray-500">
                            <div class="flex items-center">
                                ...
                                Registrado: {{ new Date(dependiente.created_at).toLocaleDateString() }}
                            </div>
                            <div class="flex items-center">
                ...
                <form @submit.prevent="submit" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Edad actual: {{ edadCalculada }} años
                                </p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    Máximo 500 caracteres. Restantes: {{ 500 - (form.observaciones?.length || 0) }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end space-x-4">
                        ...
                        >
                            ...
                            <span v-else>Actualizar Dependiente</span>
                        </button>
                    </div>
                </form>
            </div>
...
const form = useForm({
    ...
    tipo_documento: props.dependiente.tipo_documento,
    numero_documento: props.dependiente.numero_documento,
    fecha_nacimiento: formatearFechaParaInput(props.dependiente.fecha_nacimiento),
    genero: props.dependiente.genero,
    parentesco: props.dependiente.parentesco,
    telefono: props.dependiente.telefono || '',
    observaciones: props.dependiente.observaciones || '',
    activo: props.dependiente.activo
});
...
// Calcular edad basada en la fecha del formulario
...
// Métodos
const submit = () => {
    form.put(route('paciente.dependientes.update', props.dependiente.id), {
        onSuccess: () => {
            // La redirección se maneja desde el controlador, pero podemos mostrar mensaje antes
            showNotification('success', 'Dependiente actualizado', 'Los cambios han sido guardados exitosamente.');
        },
        onError: (errors) => {
            const errorMessage = errors.message || 'Ocurrió un error al actualizar el dependiente.';
