            ...
            >
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <div class="flex items-start text-sm text-gray-600">
                        <span class="font-medium w-16">Roles:</span>
                ...
                <div class="flex items-center justify-end space-x-3 pt-3 border-t border-gray-200">
                    <Link
                        :href="`/admin/users/${user.id}`"
                        class="inline-flex items-center px-3 py-2 border border-gray-300 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 transition-colors"
                    >
                    ...
                    >
                        <CheckCircleIcon v-if="user.estado" class="h-4 w-4 mr-2" />
                        <ExclamationTriangleIcon v-else class="h-4 w-4 mr-2" />
