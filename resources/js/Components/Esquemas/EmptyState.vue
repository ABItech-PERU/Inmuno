...
<template>
    <div class="text-center py-8 sm:py-12 px-4">
        <!-- Icono -->
        <ClipboardDocumentListIcon class="mx-auto h-10 w-10 sm:h-12 sm:w-12 text-cyan-400" />

        <!-- Título -->
        <h3 class="mt-2 text-sm sm:text-base font-medium text-gray-900">
            No hay esquemas de vacunación
        </h3>
        ...
        <p class="mt-1 text-xs sm:text-sm text-gray-500 max-w-sm mx-auto">
            {{ hasFilters
                ...
                : 'Comienza creando un nuevo esquema de vacunación basado en el protocolo nacional.'
            }}
        </p>

        <!-- Información adicional para cuando no hay filtros -->
        <div v-if="!hasFilters" class="mt-3 text-xs text-gray-400 max-w-md mx-auto">
            Los esquemas de vacunación organizan las vacunas por grupos de edad según las normas del MINSA.
        </div>
