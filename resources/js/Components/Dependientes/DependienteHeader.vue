            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                ...
                <div class="flex items-center space-x-3">
                    <div class="flex-shrink-0">
                        <UserGroupIcon class="h-7 w-7 sm:h-8 sm:w-8 text-cyan-600" />
                    </div>
                    <div>
                        ...
                        <p class="text-xs sm:text-sm text-gray-600 hidden sm:block">
                            Administra la información de tus dependientes
                        </p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                    <Link
                        href="/paciente/dependientes/create"
                    ...
                    >
                        ...
                        <span class="hidden xs:inline mr-1">Nuevo </span>dependiente
                    </Link>
                </div>
            </div>
        </div>
